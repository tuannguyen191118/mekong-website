...
const products = [
  {
    ...
    category: "Hộp giấy",
    desc:
      "Thiết kế hộp giấy sang trọng dành cho mỹ phẩm và quà tặng thương hiệu.",
...

  {
    ...
    desc:
      "Bao bì thực phẩm phong cách hiện đại, phù hợp cafe và F&B.",
...

  {
    ...
    category: "Tem nhãn",
    desc:
      "Tem nhãn sắc nét, chống nước, phù hợp chai lọ mỹ phẩm.",
...

  {
    ...
    category: "Túi giấy",
    desc:
      "Túi giấy thương hiệu dành cho thời trang và retail.",
